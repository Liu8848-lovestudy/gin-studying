...
func isLogin() gin.HandlerFunc {
	...
	return func(context *gin.Context) {
		...
		////fmt.Println("123")
		////fmt.Println(tokenString)
		//token, err := jwt.ParseWithClaims(tokenString, &entity.Manager{}, func(token *jwt.Token) (interface{}, error) {
		...
		//fmt.Println(token)
		//if tokenString == "" {
		//	context.JSON(http.StatusUnauthorized,"还未登录")
		//}
		//token,claim,err :=
...
func main() {
	...
	//图书借阅
	server.POST("/addBookLent/:stuId/:bookId", func(context *gin.Context) {
		//代码
	...
	//图书归还
	server.DELETE("/deleteBookLent/:stuId/:bookId", func(context *gin.Context) {
		//代码
		stuId := context.Param("stuId")
		bookId := context.Param("bookId")
		var bl entity.BookLent
